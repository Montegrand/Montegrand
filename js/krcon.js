window.onload = function () {
    ...
    class DataInfo {
        constructor(name, header, tbox, d3h) {
            this.name = name;
            this.header = header;
            this.tbox = tbox;
            this.d3h = d3h;
            this.imgUrl = `../images/krcon/${d3h}.png`;
            this.imgAlt = this.d3h;
        }
    }
    ...
    class DataT {
        ...
        newData( name, header, tbox, d3h ) {
            let arrChild = new DataInfo( name, header, tbox, d3h );
...
console.log(datat.datat[0]);
    ...
    d3.style.background = `url(${datat.datat[0].imgUrl}) 50% 0 / contain no-repeat`;
    d3h.textContent = datat.datat[0].d3h;
    console.log(datat.datat[1].d3h)
    //depth3 
    ...
    bt.forEach(function (v, n, Node) {
        ...
        function tap() {
            ...
            d3.style.background = `url(${datat.datat[n].imgUrl}) 50% 0 / contain no-repeat`;
            d3h.textContent = datat.datat[n].d3h;
            //depth3 
        };
