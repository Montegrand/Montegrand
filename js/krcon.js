window.onload = function () {
    ...
    let boxT = [
        // 참고 책 375~390p url 규칙
        {
            ...
            "box1H": "전남도립미술관",
            "box1I": "url(../images/krcon/bild_1.png)"
        },
    ...
    // function boxT(subject, credit) {
    //     this.subject = img;
    //     this.credit = '../images/bild_01.png'
    // }
    var box4 = document.querySelector('.sec.snd .depth.trd > div:first-child');
    box4.style.background = boxT[0].box1I + '50% 0';
    ...
    bt.forEach(function (v, n, Node) {
        ...
        function tap() {
            ...
            box4.style.background = boxT[n].box1I + '50% 0';
            box4.style.backgroundRepeat = 'no-repeat';
            box4.style.backgroundSize = 'contain';
            //depth3 
